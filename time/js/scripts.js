...
var progressInterval = setInterval(function() {
    ...
    if (progressInfoElement.innerHTML = "Seconds: " + elapsedSeconds + " (Remaining: " + remainingSeconds + ")") {
        progressInfoElement.innerHTML = "Seconds: " + elapsedSeconds + " (Remaining: " + remainingSeconds + ")" + " (" + "Progress: " + progressPercentage.toFixed(8) + "%" + ") ";
    }
...
var progressInterval_12 = setInterval(function() {
    ...
    if (progressInfoElement_12.innerHTML !== "Seconds: " + elapsedSeconds_12 + " (Remaining: " + remainingSeconds_12 + ")") {
        progressInfoElement_12.innerHTML = "Seconds: " + elapsedSeconds_12 + " (Remaining: " + remainingSeconds_12 + ")" + " (" + "Progress: " + progressPercentage_12.toFixed(8) + "%" + ") ";
